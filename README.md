# Hi there, I'm Hopolang Thato Botsane

I am a **Self-taught Interface Designer and Developer** with the objective of being a competent product manager.

The Philosophy
I focus on crafting seamless User Experiences (UX) that help people reach their objectives efficiently, powered by User Interfaces (UI) that feel intentional and high-end. Whether I'm wireframing in Figma or architecting a site in Next.js, my objectives are always the same: **Functionality wrapped in beauty.**

My Toolbox
*   **The Code:** HTML5, CSS3, JavaScript (ES6+), React, Next.js.
...
Developed and designed by [Thato Hopolang Botsane (THB)]
...
*“Getting users to their goals is the objective; making the journey beautiful is the craft.”*
